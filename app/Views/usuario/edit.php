			...
			<div class="col-12">
				<div class="card bg-white border-0 shadow-sm">
				  <div class="card-body">
					...
					<div class="row">
						<div class="col-12">
							<form method="post" action="/Usuario/update/<?= $field['id'];?>">	
							  <?= csrf_field() ?>
							  <div class="mb-3">
							  ...
							  <div class="mb-3">
								...
								<input type="text" class="form-control" id="login" name="Login" value="<?= $field['login'];?>">
							  </div>
							  <div class="mb-3">
								<label for="LSenha" class="form-label">Senha</label>
								<input type="text" class="form-control" id="senha" name="Senha" value="<?= $field['senha'];?>">
							  </div>
